...
Class Seperator
    ...
    Public Sub New(r1 As Rectangle)
        Me.R1 = r1
    End Sub
    ...
    Public Property B11 As LinearGradientBrush

    Public Property R11 As Rectangle
        Get
            Return R1
        End Get
    ...
    Public Property Rotation1 As Integer
        Get
            Return Rotation
        End Get
    ...
    Public Overrides Function Equals(obj As Object) As Boolean
        Dim seperator = TryCast(obj, Seperator)
        Return seperator IsNot Nothing AndAlso
               EqualityComparer(Of Rectangle).Default.Equals(R1, seperator.R1)
    End Function

    Public Overrides Function GetHashCode() As Integer
        Return 9887660 + EqualityComparer(Of Rectangle).Default.GetHashCode(R1)
    End Function
End Class
